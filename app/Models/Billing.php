...
class Billing extends Model
{
    ...
    /**
     * Scope to filter billings by department.
     * A billing belongs to a department if:
     * - The billing's doctor belongs to that department, OR
     * - The billing's patient belongs to that department (via doctor relationships)
     * 
    ...
    /**
     * Scope to filter billings by multiple departments.
     * 
     * @param \Illuminate\Database\Eloquent\Builder $query
    ...
    /**
     * Scope to filter billings visible to a specific user based on role.
     * 
     * For Doctors:
     * - Billings they created (doctor_id matches), OR
     * - Billings for patients in their department(s), OR
     * - Billings for patients they created
     * 
     * For Admins:
     * - All billings (no filtering)
     * 
     * For other roles:
     * - Billings in their department(s)
     * 
     * @param \Illuminate\Database\Eloquent\Builder $query
    ...
    /**
     * Check if a billing is visible to a specific user.
     * 
     * @param \App\Models\User|int|null $user User model, user ID, or null (uses Auth::user())
     * @return bool
     */
