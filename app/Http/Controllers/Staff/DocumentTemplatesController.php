...
class DocumentTemplatesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('staff.document-templates.index', compact('templates'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.document-templates.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('staff.document-templates.index')
    ...
    public function show(Request $request, DocumentTemplate $documentTemplate)
    {
        ...
        return view('staff.document-templates.show', compact('documentTemplate'));
    }
    ...
    public function edit(DocumentTemplate $documentTemplate)
    {
        ...
        return view('staff.document-templates.edit', compact('documentTemplate'));
    }
