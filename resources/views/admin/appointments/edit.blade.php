                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control uk-date @error('next_appointment_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('next_appointment_date') ? (old('next_appointment_date') && preg_match('/^\d{4}-\d{2}-\d{2}$/', old('next_appointment_date')) ? \Carbon\Carbon::parse(old('next_appointment_date'))->format('d/m/Y') : old('next_appointment_date')) : ($appointment->next_appointment_date ? $appointment->next_appointment_date->format('d/m/Y') : '') }}"
                                           placeholder="dd/mm/yyyy" 
                                           pattern="\d{2}/\d{2}/\d{4}" 
                                           maxlength="10">
                                    <small class="form-text text-muted">Format: dd/mm/yyyy (e.g., 15/01/2025)</small>
