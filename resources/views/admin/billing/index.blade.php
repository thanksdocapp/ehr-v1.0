...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1><i class="fas fa-file-invoice-dollar me-2 text-primary"></i>Billing Management</h1>
        <p class="page-subtitle text-muted">Manage and track all billing records and payments</p>
    </div>
