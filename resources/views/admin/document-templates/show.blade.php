    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="btn-group">
            @can('update', $documentTemplate)
                <a href="{{ route('admin.document-templates.edit', $documentTemplate) }}" class="btn btn-warning">
            ...
            <div class="doctor-card mb-4">
                ...
                <div class="doctor-card-body">
                    <div class="d-grid gap-2">
                        @can('update', $documentTemplate)
                            <a href="{{ route('admin.document-templates.edit', $documentTemplate) }}" class="btn btn-warning w-100">
                        ...
                        @if($documentTemplate->is_active)
                            <form action="{{ route('admin.document-templates.deactivate', $documentTemplate) }}" 
                                  method="POST" 
                                  class="d-inline"
                        ...
                        @endif
                        @endcan
                        <a href="{{ route('admin.document-templates.index') }}" class="btn btn-outline-secondary w-100">
