...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1><i class="fas fa-plus me-2 text-primary"></i>Create New Service</h1>
        <p class="page-subtitle text-muted">Add a new medical service to the system</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="createServiceForm" method="POST" action="{{ contextRoute('services.store') }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-section-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter detailed service description" required>{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-help">Upload service image (JPEG, PNG, JPG, GIF - Max: 2MB)</div>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
        ...
        <div class="col-lg-4">
            <div class="info-card">
                <h6><i class="fas fa-info-circle me-2"></i>Service Creation Guidelines</h6>
                <ul>
                    <li>All fields marked with * are required</li>
                    <li>Service name should be descriptive and unique</li>
                    <li>Select the appropriate department for the service</li>
                    <li>Set realistic pricing and duration estimates</li>
            ...
            <div class="info-card">
                ...
                <ul>
                    <li>Use clear, patient-friendly service names</li>
                    <li>Include comprehensive service descriptions</li>
                    <li>Set competitive but fair pricing</li>
                    <li>Provide accurate duration estimates</li>
                    <li>Use professional, high-quality images</li>
                    <li>Regularly update service information</li>
                </ul>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ contextRoute('departments.index') }}" class="btn btn-outline-success btn-sm">
                    ...
                    <a href="{{ contextRoute('services.index') }}" class="btn btn-outline-secondary btn-sm">
                        <i class="fas fa-arrow-left me-1"></i>Back to Services List
                    </a>
                </div>
            </div>
        </div>
