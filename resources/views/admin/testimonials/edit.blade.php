...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1><i class="fas fa-edit me-2 text-primary"></i>Edit Testimonial</h1>
        <p class="page-subtitle text-muted">Update testimonial information and details</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="editTestimonialForm" method="POST" action="{{ contextRoute('testimonials.update', $testimonial) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    <div class="form-section-header">
                        ...
                        <small class="opacity-75">Update testimonial details</small>
                    </div>
                    <div class="form-section-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('customer_position') is-invalid @enderror" 
                                   id="customer_position" name="customer_position" value="{{ old('customer_position', $testimonial->customer_position) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('customer_company') is-invalid @enderror" 
                                   id="customer_company" name="customer_company" value="{{ old('customer_company', $testimonial->customer_company) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('review_text') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter customer review" required>{{ old('review_text', $testimonial->review_text) }}</textarea>
                ...
                <div class="form-section">
                    <div class="form-section-header">
                        ...
                        <small class="opacity-75">Photo and rating settings</small>
                    </div>
                    <div class="form-section-body">
                        <div class="form-group">
                            <label for="customer_photo" class="form-label">
                                <i class="fas fa-image me-1"></i>New Customer Photo
                            </label>
                            ...
                            <div class="form-help">Upload new photo to replace current one (Max: 2MB)</div>
                        ...
                        <div class="form-group">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="is_active">
                                    <i class="fas fa-toggle-on me-1"></i>Active Testimonial
                                </label>
                            </div>
                            <div class="form-help">Enable this testimonial to display on the website</div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="current-image">
                                        @if($testimonial->customer_photo)
                                            <img src="{{ asset('storage/' . $testimonial->customer_photo) }}" alt="{{ $testimonial->customer_name }}">
                                        @else
        ...
        <div class="col-lg-4">
            <div class="info-card">
                <h6><i class="fas fa-info-circle me-2"></i>Current Testimonial Status</h6>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <strong>Customer:</strong> {{ $testimonial->customer_name }}
                </div>
                ...
                @endif
                <div class="mb-3">
                    <strong>Created:</strong> {{ formatDate($testimonial->created_at) }}
                </div>
                <div class="mb-3">
                    <strong>Last Updated:</strong> {{ formatDate($testimonial->updated_at) }}
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <ul>
                    <li>Ensure customer name remains accurate</li>
                    <li>Update review text for clarity and impact</li>
                    <li>Upload new photos only when replacing old ones</li>
                    <li>Adjust rating to reflect actual experience</li>
                    <li>Toggle status to control visibility</li>
                </ul>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ contextRoute('testimonials.show', $testimonial) }}" class="btn btn-outline-info btn-sm">
                        <i class="fas fa-eye me-1"></i>View Testimonial
                    </a>
