...
@section('title', 'Create ' . ucfirst($type) . ' Template')
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white">
                        <h5 class="card-title mb-0">
                            <i class="fas {{ $type === 'letter' ? 'fa-envelope' : 'fa-file-alt' }} me-2 text-primary"></i>
                            Create {{ ucfirst($type) }} Template
                        </h5>
                    </div>
                    <div class="card-body">
                        <!-- Template Name -->
                        ...
                        <div class="mb-3">
                            ...
                            <div class="editor-container">
                                ...
                                <div class="editor-content" contenteditable="true" id="editor">
                                    {!! old('content', '<p>Start typing your template content here...</p>') !!}
                                </div>
                            </div>
