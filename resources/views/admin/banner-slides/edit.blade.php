...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1><i class="fas fa-edit me-2 text-primary"></i>Edit Banner Slide</h1>
        <p class="page-subtitle text-muted">Update banner slide information and settings</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="editBannerSlideForm" method="POST" action="{{ contextRoute('banner-slides.update', $slide) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-section">
                    <div class="form-section-header">
                        ...
                        <small class="opacity-75">Update banner slide text content and messaging</small>
                    </div>
                    <div class="form-section-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('subtitle') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter slide subtitle">{{ old('subtitle', $slide->subtitle) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $slide->sort_order) }}" 
                                           min="1" placeholder="1">
                                ...
                                <div class="form-group">
                                    <label for="image" class="form-label">
                                        <i class="fas fa-image me-1"></i>New Banner Image
                                    </label>
                                    <input type="file" class="form-control @error('image') is-invalid @enderror" 
                                           id="image" name="image" accept="image/*">
                                    <div class="form-help">Upload new image to replace current one (Max: 2MB)</div>
                                    @error('image')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <input type="color" class="form-control color-preview @error('background_color') is-invalid @enderror" 
                                               id="background_color" name="background_color" value="{{ old('background_color', $slide->background_color) }}" 
                                               style="width: 60px; height: 40px; padding: 0;">
                                        <input type="text" class="form-control ms-2 @error('background_color') is-invalid @enderror" 
                                               id="background_color_text" value="{{ old('background_color', $slide->background_color) }}" 
                ...
                <div class="form-section">
                    <div class="form-section-body text-center">
                        <button type="submit" class="btn btn-primary btn-lg me-3">
                            <i class="fas fa-save me-2"></i>Update Banner Slide
                        </button>
        ...
        <div class="col-lg-4">
            <div class="info-card">
                <h6><i class="fas fa-info-circle me-2"></i>Current Slide Status</h6>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <strong>Created:</strong> {{ formatDate($slide->created_at) }}
                </div>
                <div class="mb-3">
                    <strong>Last Updated:</strong> {{ formatDate($slide->updated_at) }}
                </div>
            </div>
            ...
            <div class="info-card">
                ...
                <ul>
                    <li>Ensure title remains compelling and concise</li>
                    <li>Update button links and text if necessary</li>
                    <li>Keep background colors consistent with branding</li>
                    <li>Upload new images only when replacing old ones</li>
                    <li>Adjust sort order to change slide sequence</li>
                </ul>
            </div>
            ...
            <div class="info-card">
                ...
                <div class="d-grid gap-2">
                    <a href="{{ contextRoute('banner-slides.show', $slide) }}" class="btn btn-outline-info btn-sm">
                        <i class="fas fa-eye me-1"></i>View Slide
                    </a>
                    <a href="{{ contextRoute('banner-slides.index') }}" class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-list me-1"></i>All Slides
                    </a>
...
$(document).ready(function() {
    ...
    // Form validation
    $('#editBannerSlideForm').on('submit', function(e) {
        let isValid = true;
