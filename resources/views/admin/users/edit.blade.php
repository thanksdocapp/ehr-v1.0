                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    ...
                                    <input type="text" class="modern-form-control uk-date @error('hire_date') is-invalid @enderror"
                                           ...
                                           value="{{ old('hire_date') ? (old('hire_date') && preg_match('/^\d{4}-\d{2}-\d{2}$/', old('hire_date')) ? \Carbon\Carbon::parse(old('hire_date'))->format('d/m/Y') : old('hire_date')) : ($user->hire_date ? $user->hire_date->format('d/m/Y') : '') }}"
