...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1 class="mb-0"><i class="fas fa-search me-2 text-primary"></i>Create SEO Page</h1>
        <p class="page-subtitle text-muted">Add a new page for SEO optimization</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="createSEOForm" action="{{ contextRoute('seo.pages.store') }}" method="POST">
                @csrf
                ...
                <div class="form-section text-center">
                    <button type="submit" class="btn btn-primary btn-lg me-3">
                        <i class="fas fa-save me-2"></i>Create SEO Page
                    </button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    titleInput.addEventListener('input', function() {
        ...
        if (slug && !urlInput.value) {
            urlInput.value = '/' + slug;
        }
        updateSeoScore();
    });
    
    // Update SEO score when inputs change
    [urlInput, metaKeywordsInput, canonicalUrlInput].forEach(input => {
