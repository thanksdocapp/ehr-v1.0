...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1 class="mb-0"><i class="fas fa-sms me-2 text-primary"></i>Create SMS Template</h1>
        <p class="page-subtitle text-muted">Create a new SMS template for automated text communications</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="createSMSTemplateForm" action="{{ contextRoute('sms-templates.store') }}" method="POST">
                @csrf
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sender_id') is-invalid @enderror" 
                                           id="sender_id" name="sender_id" value="{{ old('sender_id', 'HOSPITAL') }}" 
                    ...
                    <div class="form-section-body">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('message') is-invalid @enderror" 
                                      ...
                                      oninput="updateCharacterCount()">{{ old('message') }}</textarea>
