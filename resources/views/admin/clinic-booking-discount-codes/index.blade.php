...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
        <div>
            ...
            <p class="text-muted small mb-0">Used on the <strong>public clinic booking</strong> flow before payment. Managed here (admin); doctors manage their own codes under Staff.</p>
        </div>
