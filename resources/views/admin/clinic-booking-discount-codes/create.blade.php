...
@section('title', 'New clinic booking code')
...
<div class="container-fluid">
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white"><strong>New code — {{ $department->name }}</strong></div>
        <div class="card-body">
            @if($errors->any())
            <div class="alert alert-danger"><ul class="mb-0">@foreach($errors->all() as $e)<li>{{ $e }}</li>@endforeach</ul></div>
            @endif

            <form method="POST" action="{{ route('admin.departments.clinic-booking-discount-codes.store', $department) }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
