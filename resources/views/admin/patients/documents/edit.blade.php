                ...
                <div>
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.patients.documents.show', [$patient, $document]) }}">{{ Str::limit($document->title, 20) }}</a></li>
                ...
                <div class="doctor-card mb-4">
                    ...
                    <div class="doctor-card-body">
                        <div class="d-grid gap-2">
                            ...
                            @endif
                            <a href="{{ route('admin.patients.documents.show', [$patient, $document]) }}" class="btn btn-outline-secondary w-100">
