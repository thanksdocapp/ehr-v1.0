                    ...
                    <div class="doctor-card-body">
                        ...
                        <div id="formDataSection" style="display: none;">
                            <div class="alert alert-info">
                                ...
                                <strong>Form Document:</strong> Fill in the form fields below.
                            </div>
                            <div id="formFieldsContainer"></div>
                        </div>

                        <!-- For Letters: Content Preview -->
                        <div id="letterPreviewSection" style="display: none;">
                            <div class="alert alert-info">
                                <i class="fas fa-info-circle me-2"></i>
                                <strong>Letter Document:</strong> This letter will be automatically generated from the template.
                            </div>
                            <div class="mb-3">
    ...
    $('#addPlaceholderBtn').on('click', function() {
        const placeholderHtml = `
            <div class="row mb-2 placeholder-row">
                <div class="col-5">
                    <input type="text" class="form-control form-control-sm" name="extra_placeholders[${placeholderIndex}][name]" placeholder="Placeholder name">
                </div>
                <div class="col-6">
