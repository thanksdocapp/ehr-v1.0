...
<div class="fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Import Patients from CSV</h1>
            <p class="text-muted mb-0">Bulk import patient records from a CSV file</p>
        </div>
        <div>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.patients.import.csv') }}" method="POST" enctype="multipart/form-data" id="importForm">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <small class="form-text text-muted">
                                Choose how to handle existing records based on email or patient ID
                            </small>
                            @error('import_mode')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.patients.export.csv') }}" class="btn btn-success">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 small">
                        <li>Patient ID (auto-generated if not provided)</li>
                        <li>Phone</li>
                        <li>Date of Birth</li>
                        <li>Gender</li>
                        <li>Blood Group</li>
                        ...
                        <li>Insurance Provider & Number</li>
                        <li>Allergies (comma-separated)</li>
                        <li>Medical Conditions (comma-separated)</li>
                        <li>Assigned Clinics (comma-separated clinic names)</li>
                    ...
                    <ul class="list-unstyled small mb-0">
                        ...
                        <li><i class="fas fa-lightbulb text-warning me-2"></i>Use comma-separated values for lists (allergies, clinics)</li>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <pre class="bg-light p-2 rounded small">Patient ID,First Name,Last Name,Email,Phone,Date of Birth,Gender,Blood Group,Assigned Clinics,Status
PAT001,John,Doe,john.doe@example.com,1234567890,01/15/1990,Male,A+,Cardiology,Active
PAT002,Jane,Smith,jane.smith@example.com,0987654321,05/20/1985,Female,B+,Emergency Medicine,Active</pre>
                </div>
            </div>
        </div>
    </div>
