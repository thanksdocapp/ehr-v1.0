...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.patients.show', $patient) }}" class="btn btn-outline-secondary me-2">
                <i class="fas fa-arrow-left me-2"></i>Back to Patient
            </a>
            @can('create', [\App\Models\PatientAlert::class, $patient])
            <a href="{{ route('admin.patients.alerts.create', $patient) }}" class="btn btn-primary">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.patients.alerts.index', $patient) }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3 d-flex align-items-end">
                    <a href="{{ route('admin.patients.alerts.index', $patient) }}" class="btn btn-outline-secondary w-100">
                        ...
                        <tbody>
                            @foreach($alerts as $alert)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.patients.alerts.show', [$patient, $alert]) }}" class="text-decoration-none">
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('admin.patients.alerts.show', [$patient, $alert]) }}" 
                                               class="btn btn-outline-primary" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            @can('update', $alert)
                                            <a href="{{ route('admin.patients.alerts.edit', [$patient, $alert]) }}" 
                                               class="btn btn-outline-info" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            @endcan
                                            @can('toggleActive', $alert)
                                            <form action="{{ route('admin.patients.alerts.toggle-active', [$patient, $alert]) }}" 
                                            ...
                                            @endcan
                                            @can('delete', $alert)
                                            <form action="{{ route('admin.patients.alerts.destroy', [$patient, $alert]) }}" 
                                                  method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
