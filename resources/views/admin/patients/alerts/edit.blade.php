...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.patients.alerts.update', [$patient, $alert]) }}" method="POST" id="alertEditForm">
        @csrf
        @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="card-title mb-0"><i class="fas fa-edit me-2"></i>Edit Alert Information</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ route('admin.patients.alerts.show', [$patient, $alert]) }}" class="btn btn-secondary">
                                <i class="fas fa-times me-2"></i>Cancel
                            </a>
                            <a href="{{ route('admin.patients.alerts.index', $patient) }}" class="btn btn-outline-secondary">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h6 class="card-title mb-0 fw-semibold">Current Alert Info</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <strong><a href="{{ route('admin.patients.show', $patient) }}" class="text-decoration-none">{{ $patient->full_name }}</a></strong>
                        </div>
                        <div class="mb-0">
