        ...
        <div class="modern-page-header-content">
            <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                <div>
                    ...
                    <p class="modern-page-subtitle mb-0">Update medical record with diagnosis, treatment, and vital signs</p>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                    <a href="{{ route('admin.medical-records.show', $medicalRecord->id) }}" class="btn btn-outline-primary">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control uk-date @error('follow_up_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('follow_up_date') ? (old('follow_up_date') && preg_match('/^\d{4}-\d{2}-\d{2}$/', old('follow_up_date')) ? \Carbon\Carbon::parse(old('follow_up_date'))->format('d/m/Y') : old('follow_up_date')) : ($medicalRecord->follow_up_date ? $medicalRecord->follow_up_date->format('d/m/Y') : '') }}"
