...
<div class="container-fluid">
    ...
    <div class="alert alert-info mt-3 mb-0">
        ...
        Paid clinic checkouts are auto-assigned to the clinic and its <strong>default doctor</strong> (primary doctor, or sole active doctor) and appear under <strong>Accepted clinic bookings</strong> below.
