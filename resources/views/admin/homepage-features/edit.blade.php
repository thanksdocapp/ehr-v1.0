...
@section('title', 'Edit Homepage Feature')
...
<div class="container-fluid">
    <div class="page-title mb-4">
        <h1><i class="fas fa-edit me-2 text-primary"></i>Edit Homepage Feature</h1>
        <p class="page-subtitle text-muted">Update feature details</p>
    </div>

    <div class="row">
        <div class="col-lg-8">
            <form id="editHomepageFeatureForm" method="POST" action="{{ contextRoute('homepage-features.update', $homepageFeature) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="form-section-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                   id="title" name="title" value="{{ old('title', $homepageFeature->title) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('subtitle') is-invalid @enderror" 
                                   id="subtitle" name="subtitle" value="{{ old('subtitle', $homepageFeature->subtitle) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter feature description" required>{{ old('description', $homepageFeature->description) }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                               id="icon" name="icon" value="{{ old('icon', $homepageFeature->icon) }}" 
                                               placeholder="e.g., fas fa-clock" required>
                                        <button type="button" class="btn btn-outline-secondary" id="iconPreviewBtn">
                                            <i id="iconPreview" class="{{ old('icon', $homepageFeature->icon) }}"></i> Preview
                                        </button>
                                    </div>
                                    <div class="form-help">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $homepageFeature->sort_order) }}" 
                                           min="1" placeholder="1">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               ...
                                               {{ old('is_active', $homepageFeature->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div id="feature-preview" class="text-center p-4 border rounded">
                                <div class="feature-icon mb-3">
                                    <i id="previewIcon" class="{{ old('icon', $homepageFeature->icon) }} fs-1" 
                                       style="color: {{ old('color', $homepageFeature->color) }} !important;"></i>
                                </div>
                                <h5 id="previewTitle" class="fw-bold mb-3">
                                    {{ old('title', $homepageFeature->title) }}
                                </h5>
                                <h6 id="previewSubtitle" class="text-muted mb-2" style="display: {{ old('subtitle', $homepageFeature->subtitle) ? 'block' : 'none' }}">
                                    {{ old('subtitle', $homepageFeature->subtitle) }}
                                </h6>
                                <p id="previewDescription" class="text-muted">
                                    {{ old('description', $homepageFeature->description) }}
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="info-card">
                ...
                <ul>
                    <li>Ensure title is compelling and descriptive</li>
                    <li>Use concise subtitles when applicable</li>
                    <li>Maintain detailed and clear descriptions</li>
                    <li>Select appropriate visual icons</li>
                    <li>Set display sequence using sort order</li>
                </ul>
            </div>
            ...
            <div class="info-card">
                ...
                <ul>
                    <li>Maintain consistent feature styles</li>
                    <li>Match icons with feature content</li>
                    <li>Ensure readability across text areas</li>
                    <li>Test feature appearance on different screens</li>
                    <li>Adhere to brand consistency</li>
                </ul>
            </div>
