...
<head>
    ...
    <style>
        ...
        * {
        ...
        .btn-secondary:hover {
            background: linear-gradient(135deg, #475569 0%, var(--secondary) 100%);
            transform: translateY(-2px);
        ...
        .dataTables_wrapper .dataTables_filter input:focus {
            border-color: var(--primary);
            box-shadow: 0 0 0 4px rgba(79, 70, 229, 0.1), 0 4px 12px rgba(79, 70, 229, 0.1);
            outline: none;
        ...
        .status-filter.pending:hover,
        .status-filter.pending.active {
        ...
        .status-filter.confirmed:hover,
        .status-filter.confirmed.active {
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="nav-section">
            ...
            <div class="nav-item draggable-item" data-id="{{ $customItem->id }}" style="cursor: move;">
                ...
                <a href="{{ $customItem->url }}" 
                   ...
                   style="cursor: pointer; pointer-events: auto !important; z-index: 10; flex: 1;">
            ...
            @if(session('error'))
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    ...
                    @if(session('convert_patient_id'))
                        <a href="{{ route('staff.patients.show', session('convert_patient_id')) }}" class="alert-link d-block mt-2">Open patient record to complete provisional profile &rarr;</a>
                    @endif
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            @endif
