...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('staff.form-requests.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                ...
                @if(!$formRequest->isCompleted() && !$formRequest->isExpired())
                    <div class="card-footer bg-white">
                        <form action="{{ route('staff.form-requests.resend', $formRequest) }}" method="POST" class="d-inline">
                            @csrf
            ...
            @if($formRequest->generatedDocument)
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <a href="{{ route('staff.generated-documents.show', $formRequest->generatedDocument) }}" class="btn btn-outline-primary btn-sm">
