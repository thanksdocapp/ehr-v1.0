...
<div class="fade-in-up">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <p class="text-muted mb-0 small">You set <strong>maximum uses</strong> per code when creating or editing (leave blank for unlimited). Codes apply only to your public doctor booking link. Usage is counted after payment completes, or immediately if the booking is free after the discount.</p>
