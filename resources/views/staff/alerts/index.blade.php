...
@section('page-subtitle', 'View and manage all patient alerts')
...
<div class="fade-in-up">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <small class="text-muted">View and manage all patient alerts</small>
        </div>
                        ...
                        @if($patients->count() > 0)
                            @foreach($patients as $patient)
                                <li class="patient-dropdown-item" data-search-text="{{ strtolower($patient->full_name . ' ' . $patient->patient_id . ' ' . ($patient->email ?? '')) }}">
                                    <a class="dropdown-item" href="{{ route('staff.patients.alerts.create', $patient) }}">
    ...
    <div class="doctor-card mb-4">
        ...
        <div class="doctor-card-body">
            <form method="GET" action="{{ route('staff.alerts.index') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    <a href="{{ route('staff.alerts.index') }}" class="btn btn-outline-secondary">
    ...
    <div class="doctor-card">
        <div class="doctor-card-header">
            <h5 class="doctor-card-title mb-0">All Patient Alerts</h5>
        </div>
        <div class="doctor-card-body">
            @if($alerts->count() > 0)
                    ...
                    <table class="table table-hover doctor-table">
                        ...
                        <tbody>
                            @foreach($alerts as $alert)
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('staff.patients.show', $alert->patient) }}" class="text-decoration-none">
                                    ...
                                    <td>
                                        <a href="{{ route('staff.patients.alerts.show', [$alert->patient, $alert]) }}" class="text-decoration-none">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    @if(request()->anyFilled(['status', 'severity', 'type', 'patient_id']))
                        <a href="{{ route('staff.alerts.index') }}" class="btn btn-primary">
                            <i class="fas fa-times me-2"></i>Clear Filters
                        </a>
                    @endif
                </div>
