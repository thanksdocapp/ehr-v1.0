...
<body>
    <div class="auth-card">
        ...
        <div class="auth-body">
            ...
            <form id="codeForm" action="{{ route('staff.two-factor.verify.post') }}" method="POST">
                @csrf
            ...
            <!-- Recovery Code Form -->
            <form id="recoveryForm" class="recovery-form" action="{{ route('staff.two-factor.verify.recovery') }}" method="POST">
                @csrf
    ...
    <form id="resendForm" action="{{ route('staff.two-factor.resend') }}" method="POST" class="d-none">
        @csrf
    </form>
