...
$(document).ready(function() {
    ...
    function calculateAgeAndToggleGuardian() {
        ...
        function parseUkDobStaffCreate(v) {
        ...
        const birthDate = parseUkDobStaffCreate(birthDateValue);
        ...
        // Toggle Guardian ID + contact required for under 18
        if (years < 18) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    icon: 'info',
                    title: 'Guardian details required',
                    text: `Patient is ${years} years, ${months} months old (under 18). Guardian/parent name, phone, and ID document are required.`,
                    timer: 3500,
                    showConfirmButton: false,
                    toast: true,
                    position: 'top-end'
    ...
    @if($errors->has('guardian_id_document') || $errors->has('guardian_name') || $errors->has('guardian_phone'))
        console.log('Guardian validation error detected');
