...
<div class="fade-in-up">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="doctor-card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-control-plaintext">
                                <a href="{{ route('staff.patients.show', $patient) }}" class="text-decoration-none">
            ...
            <div class="doctor-card mb-4">
                <div class="doctor-card-header">
                    <h5 class="doctor-card-title mb-0"><i class="fas fa-history me-2"></i>Audit Information</h5>
                </div>
                <div class="doctor-card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
            ...
            <div class="doctor-card mb-4">
                ...
                <div class="doctor-card-body">
                    <div class="d-grid gap-2">
                        @can('update', $alert)
                        <a href="{{ route('staff.patients.alerts.edit', [$patient, $alert]) }}" class="btn btn-doctor-primary">
                            <i class="fas fa-edit me-2"></i>Edit Alert
                        </a>
                        @endcan
                        @can('toggleActive', $alert)
                        <form action="{{ route('staff.patients.alerts.toggle-active', [$patient, $alert]) }}" method="POST">
                            @csrf
                        ...
                        @endcan
                        @can('delete', $alert)
                        <form action="{{ route('staff.patients.alerts.destroy', [$patient, $alert]) }}" method="POST" 
