...
@section('page-subtitle', 'Complete patient details to enable medical records and prescriptions')
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-light border mb-4" role="alert">
                        <p class="mb-0 small">
                            ...
                            <a href="{{ route('staff.patients.edit', $patient) }}">Open the full patient profile</a> to fill every required field in one place. When nothing essential is missing, guest restrictions clear automatically — you do not have to use this quick form.
                        </p>
                    </div>
