    ...
    <form id="patient-details-form" method="POST" action="{{ route('public.booking.clinic-review') }}" data-session-dob-ymd="{{ $pbSessionDobYmd }}">
        ...
        <div class="form-card">
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">Shared with clinic staff from your booking (before your visit). On this device, a draft is kept for 60 seconds if you refresh the page.</small>
            </div>
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ route('public.booking.clinic', ['slug' => $department->slug]) }}" class="btn btn-outline-secondary btn-lg"><i class="fas fa-arrow-left me-2"></i>Back</a>
