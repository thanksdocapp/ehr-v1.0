...
return new class extends Migration
{
    ...
    {
        // SQLite: skip column alters (MySQL MODIFY / change() rebuild breaks FK graphs in tests).
        if (Schema::getConnection()->getDriverName() === 'sqlite') {
            return;
        }

        // Use raw SQL to modify columns since Laravel Schema doesn't support changing ENUM columns directly (MySQL)
