...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_notifications', function (Blueprint $table) {
            ...
            $table->string('type', 50)->index(); // appointment, prescription, lab_result, billing, medical_record, system, etc.
            $table->string('title');
            $table->text('message');
            $table->json('data')->nullable(); // Additional data like appointment_id, prescription_id, etc.
