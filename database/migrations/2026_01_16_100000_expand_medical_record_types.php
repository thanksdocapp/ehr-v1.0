...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // PostgreSQL and others with check constraints
        try {
            ...
            \Log::warning('Could not update medical_records.record_type constraint: ' . $e->getMessage());
        }
    }
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement("
                ...
                SELECT
                    ...
                    CASE
                        WHEN record_type IN ('emergency', 'routine_checkup', 'procedure', 'administration_update') THEN 'consultation'
                        ELSE record_type
                    END as record_type,
